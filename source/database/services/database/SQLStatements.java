...
public class SQLStatements {
	...
	public static final String	EXPENSE_SELECT_AUTOCOMPLETE_CATEGORY	= "SELECT category as first, name as second, count(category) as count FROM expense group by name, category;";
	public static final String	EXPENSE_SELECT_AUTOCOMPLETE_NAME		= "SELECT name as first, '' as second, count(name) as count FROM expense group by name;";
