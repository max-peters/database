...
public class RefillingDatabaseConnector implements IDatabaseConnector<Refilling> {
	@Override
	public Refilling create(ResultSet resultSet) throws SQLException {
		return new Refilling(resultSet.getDouble("distance"), resultSet.getDouble("refuelAmount"),
				resultSet.getDouble("cost"), resultSet.getDate("date").toLocalDate());
	}
	...
	@Override
	public PreparedStatement prepareStatement(Refilling refilling, String query) throws SQLException {
