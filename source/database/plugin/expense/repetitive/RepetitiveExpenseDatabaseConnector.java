...
public class RepetitiveExpenseDatabaseConnector implements IDatabaseConnector<RepetitiveExpense> {
	@Override
	public RepetitiveExpense create(ResultSet resultSet) throws SQLException {
		return new RepetitiveExpense(resultSet.getString("name"), resultSet.getString("category"),
	...
	@Override
	public PreparedStatement prepareStatement(RepetitiveExpense repetitiveExpense, String query) throws SQLException {
