...
public class Main {
	public static void main(String[] args) {
		try {
			...
			SubjectPlugin subjectPlugin = new SubjectPlugin(pluginContainer, storage);
			ExpensePlugin expensePlugin = new ExpensePlugin(pluginContainer, storage);
			RefillingPlugin refillingPlugin = new RefillingPlugin(pluginContainer, (ExpenseList) expensePlugin.getInstanceList(), storage);
			TaskPlugin taskPlugin = new TaskPlugin(pluginContainer, storage);
			EventPlugin eventPlugin = new EventPlugin(pluginContainer, storage);
